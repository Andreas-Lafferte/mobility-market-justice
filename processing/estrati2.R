...
elsoc_long_2016_2023$perc_inequality2 <- sjlabelled::set_label(elsoc_long_2016_2023$perc_inequality2,
                                                          label = "Percepción desigualdad")

# Getting ahead

elsoc_long_2016_2023 %>% 
  filter(ola %in% c(1,3,7)) %>% 
  group_by(ola) %>% frq(d05_03) # ok

elsoc_long_2016_2023 %>% 
  filter(ola %in% c(1,3,7)) %>% 
  group_by(ola) %>% frq(d05_04) # ok
