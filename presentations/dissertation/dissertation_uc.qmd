...
- RQ1: _¿Cómo afecta la movilidad social intergeneracional a las preferencias por la comodificación de las pensiones en Chile?_
...
- Hipótesis de aculturación y self serving-bias: cambio en los criterios de justicia [@jaime-castillo_social_2019; @gugushvili_subjective_2017]
...
- **Meritocracia**: 2 ítems (esfuerzo, talento) — Likert 1–5; promedio y dicotomía baja (≤3) vs alta (≥4) [@young_rise_1958].
...
- Todos los modelos incluyen:
    ...
    * FE de ola debido a la estructura panel de los datos
...
1. ¿Cómo la movilidad social afecta las preferencias por la comodificación de las pensiones en Chile? ¿Qué rol juegan las percepciones meritocráticas?

    * La movilidad desde posiciones de mediano estatus hacia alto estatus incrementan el apoyo a la comodificación de las pensiones; mientras que las trayectorias descendentes de alta a media y de alta a baja lo reducen
...
2. Contribuciones:
    ...
    * Metodológico: línea de aproximación creciente de los efectos de la movilidad [@breen_effects_2024; @song_there_2025]
...
3. Limitaciones y proyecciones: 
    ...
    * Estimación depende del fuerte supuesto de que el conjunto $C$ es suficiente (revisar y mejorar)
