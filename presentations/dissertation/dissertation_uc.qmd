...
En América Latina, modificaron la arquitectura de las instituciones del bienestar expandiendo la lógica de mercado [@ferre_welfare_2023; @madariaga_three_2020]

:::

::: {.box-inv-4 .sp-after .fragment style="font-size: 110%;"}

Economía moral: efectos de retroalimentación en las actitudes públicas [@lindh_public_2015; @svallforsMoralEconomyClass2006a]
...
## Comodificación de las pensiones

::: {.box-inv-4 .sp-after .fragment style="font-size: 110%;"}

En América Latina, la privatización de las pensiones y la expansión de esquemas de capitalización individual han sido claves [@huber_political_2000; @verbic_political_2019]

:::

::: {.box-inv-4 .sp-after .fragment style="font-size: 110%;"}

Reasigna los riesgos de la vejez, vincula beneficios con las trayectorias de contribución y moldea las normas públicas sobre lo que es justo en materia de pensiones [@madero-cabib_private_2019; @oecd_pensions_2023; @arza_pension_2008; @borzutzky_pension_2012]

:::

::: {.box-inv-5 .sp-after-half .fragment style="font-size: 110%;"}

Preferencias por al comodificación de las pensiones en Chile: creencias normativas que legitiman que el acceso a mejores pensiones dependa de criterios de mercado [@lindh_public_2015] 
...
## Este estudio {data-background-color="#523870"}

:::: {.incremental style="font-size: 170%;"}

1) _¿Cómo la movilidad social intergeneracional afecta las preferencias por la comodificación de las pensiones en Chile?_

2) _¿Cómo las creencias meritocráticas condicionan la relación entre movilidad social y comodificación?_
...
- Cambios en un outcome que se derivan del _movimiento_ entre clases de origen y destino [ @fosse_diagonal_2025]
- Exposición a nuevos riesgos, recursos y contextos normativos [@helgason_longterm_2023; @alesina_intergenerational_2018; @jaime-castillo_social_2019]
- Diversos **mecanismos explicativos**: 
    
    * Interés material: **míope** y anticipación
    * Socialización: **aculturación**, socialización primaria y máximización estatus
    * Atribuciones causales (ej. self-serving bias) y aprendizaje acumulado de clase

:::


## Hipótesis: movilidad social
...
- $H_{2a}$ (Upward × meritocracia): con alta meritocracia, la movilidad ascendente aumenta más el apoyo a pensiones vía mercado (vs baja).

- $H_{2b}$ (Downward × meritocracia): con baja meritocracia, la movilidad descendente reduce el apoyo; con alta, el efecto negativo se atenúa (≈ neutral/lig. +).
...
3. **Limitaciones y proyecciones**: 
    ...
    * Sin validez externa → comparaciones entre países
:::
