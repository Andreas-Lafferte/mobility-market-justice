...
Chile combina una elevada desigualdad, una profunda privatización del bienestar y un sistema de pensiones privado [@flores_top_2020; @somma_no_2021; @madariaga_three_2020]
...
- ¿Cómo afecta la movilidad social intergeneracional las preferencias por la comodificación de las pensiones en Chile?
...
1) La movilidad intergeneracional hacia y desde posiciones de alto estatus afectan causalmente el apoyo a la mercantilización de las pensiones, mientras que las trayectorias descendentes de alta a media y de alta a baja lo reducen [@gugushvili_subjective_2017; @helgason_longterm_2023; @busemeyer_welfare_2020; @ares_changing_2020]

2) Las creencias meritocráticas se correlacionan con estas preferencias, pero parecen operar en una vía paralela a la movilidad [@rodriguez_intergenerational_2024]

3) Trabajo futuro: ajustar enfoque y enviarlo, mejorar las medidas del lado del origen ($C$) e incorporar baterías más ricas de ítems de justicia de mercado 
