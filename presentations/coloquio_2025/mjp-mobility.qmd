...
Preferencias por justicia de mercado [@busemeyer_skills_2014; @immergut_it_2020; @castillo_perceptions_2025; @koos_moral_2019; @lindh_public_2015]
...
El movimiento entre posiciones expone experiencias y **mecanismos** que afectan nociones de justicia
...
- Creencias sobre la desigualdad [@gugushvili_intergenerational_2016; @bucca_merit_2016; @shariff_income_2016; @day_movin_2017]
- Apoyo al gasto social y políticas de bienestar [@gugushvili_subjective_2017; @gugushvili_intergenerational_2016c]
...
- Intereses materiales [@helgason_class_2025]
- Socialización [@jaime-castillo_social_2019]
- **Self-serving bias** [@schmidt_experience_2011; @gugushvili_intergenerational_2016c; @molina_its_2019].
- Meritocracia como proxy al sesgo de atribuciones internas y externas [@young_rise_1958]
:::
:::::
...
ggplot(df_health_lab, aes(x = estimate, y = term)) +
  ...
  geom_text(aes(label = est_lab), vjust = -0.8, size = 3.3) +
...
3. **Mediación**: rol de la meritocracia como mediador → ACME [@imai_identification_2010], moderación (?)
:::
