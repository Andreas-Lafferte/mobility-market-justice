...
Meritocracia como mecanismo de sesgo de atribución[@schmidt_experience_2011; @gugushvili_intergenerational_2016c; @molina_its_2019].
...
- Para estimar el efecto causal de la movilidad social, utilizo modelos de regresión lineal con ponderaciones de probabilidad inversa (IPW) para la movilidad condicional a la clase de origen [@breen_effects_2024]

- Para mediación ocupo el estimador Average Causal Mediation Effect [@imai_identification_2010]
...
#| label: fig-me
#| fig-cap-location: top
#| fig-cap: "Estimaciones de efectos de mobilidad en preferencia por comodificación en educación"
#| fig-align: center
#| out-width: '180%'
...
#| label: fig-mp
#| fig-cap-location: top
#| fig-cap: "Estimaciones de efectos de mobilidad en preferencia por comodificación en pensiones"
#| fig-align: center
#| out-width: '180%'
